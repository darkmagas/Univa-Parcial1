...
public class EnemyManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject _ultramidEnemyPrefab;
    [SerializeField] private GameObject _strongEnemyPrefab;
    [SerializeField] private GameObject _ultrastrongEnemyPrefab;
    ...
    private IEnumerator CreateWave()
    {
        ...
        yield return StartCoroutine(SpawnEnemies(wave.ultramidEnemy, _ultramidEnemyPrefab));
        yield return StartCoroutine(SpawnEnemies(wave.strongEnemy, _strongEnemyPrefab));
        yield return StartCoroutine(SpawnEnemies(wave.ultrastrongEnemy, _ultrastrongEnemyPrefab));
        _currentWave++;
